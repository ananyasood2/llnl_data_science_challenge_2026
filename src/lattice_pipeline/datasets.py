"""Shared locations and physical defaults for bundled inspection datasets."""
...
def get_dataset(key: str) -> dict:
    """Return a dataset config or raise a user-facing availability error."""
...
__all__ = ["DATASETS", "REPO_ROOT", "get_dataset"]
